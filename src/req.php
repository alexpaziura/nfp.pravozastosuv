...
<?php if (isset($_REQUEST["table"]) && $_REQUEST["table"] === 'inspekt') {
    ?>
    <div class="container-fluid">
        <div class="panel panel-default panel-table" style="margin-top: 5px; border: 0;">
            <div class="panel-body" style="padding: 0; background-color: #052A68;">
                ...
                <div class="">
                    <table
                        ...
                        <tr>
                            ...
                            <th data-field="id_inspekt" data-sortable="true" rowspan="4" data-halign="center"
                                data-align="center"
                                class="col-xs-1">id_inspekt
                            </th>
                            <th data-field="active" data-sortable="true" rowspan="4" data-halign="center"
                                data-align="center"
                                class="col-xs-1">active
                            </th>
                            <th data-field="date_change" data-sortable="true" rowspan="4" data-halign="center"
                                data-align="center"
                                class="col-xs-1">date_change
                            </th>
                            <th data-field="username" data-sortable="true" rowspan="4" data-halign="center"
                                data-align="center"
                                class="col-xs-1">username
                            </th>
                            <th data-field="nzp" data-sortable="true" rowspan="4" data-halign="center"
                                data-align="center"
                                class="col-xs-1">№<br>з/п <br>[1]
                            </th>
                            <th data-field="pidrozdil" data-sortable="true" rowspan="4" data-halign="center"
                                data-align="center"
                            ...
                            <th data-field="edrpo" class="col-xs-1" data-sortable="true" rowspan="4"
                                data-halign="center"
                                data-align="center">Код за ЄДРПОУ ФУ<br>або ІНН або паспорт<br>[4]
                            </th>
                            <th data-field="type_fo" data-sortable="true" rowspan="4" data-halign="center"
                                data-align="center">
                            ...
                            <th colspan="2" data-halign="center" data-align="center">Термін проведення<br> перевірки
                            </th>
                            <th colspan="2" data-halign="center" data-align="center">Період діяльності,<br> що
                                охоплюються
                                перевіркою
                            </th>
                            <th colspan="2" data-halign="center" data-align="center">Наказ про здійснення<br>заходу
                                державного
                                нагляду
                            </th>
                            ...
                            <th colspan="7" data-halign="center" data-align="center">Розпорядження про усунення
                                порушень
                            </th>
                            <th colspan="8" data-halign="center" data-align="center">Постанова про застосування штрафної
                                санкції
                            </th>
                            <th colspan="23" data-halign="center" data-align="center">Процедури стягнення в судовому
                                порядку
                            </th>

                            <th colspan="8" data-halign="center" data-align="center">Процедури примусового стягнення за
                                рішенням
                                суду
                            </th>
                        ...
                        <tr>
                            ...
                            <th data-field="d_akt_zu" data-sortable="true" rowspan="3" data-halign="center"
                                data-align="center">
                                Дата<br>[20]
                            </th>
                            <th data-field="n_akt_zu" data-sortable="true" rowspan="3" data-halign="center"
                                data-align="center">
                                Номер<br>[21]
                            </th>
                            ...
                            <th data-field="info_splat_shtraf" data-sortable="true" rowspan="3" data-halign="center"
                                data-align="center">Інформація про<br>сплату штрафу<br>(Дата сплати по<br>платіжному
                                дорученню)
                                <br>[34]
                            </th>
                            ...
                            <th data-field="dn_sluj_nap_mat" data-sortable="true" rowspan="3" data-halign="center"
                                data-align="center">Дата/номер службової записки<br> щодо направлення матеріалів<br> для
                                подання
                                позовної заяви<br>[40]
                            </th>
                            <th data-field="name_sud_dn_poz" data-sortable="true" rowspan="3" data-halign="center"
                                data-align="center">Назва суду,дата/номер позовної заяви<br>про стягення штрафної
                                санкції
                            </th>
                            <th colspan="15" data-halign="center" data-align="center">Судовий розгляд</th>
                            <th colspan="3" data-halign="center" data-align="center">Інформація щодо розподілу судових
                                витрат
                            </th>
                            <th data-field="dn_list_dobro_splat" data-sortable="true" rowspan="3" data-halign="center"
                                data-align="center">Дата/№ листа до суб'єкту <br>нагляду про добровільну сплату<br>
                                штрафної
                            ...
                            <th data-field="shtraf_splach_dobro" data-sortable="true" rowspan="3" data-halign="center"
                                data-align="center">Штрафна санкція сплачена <br>добровільно за рішенням суду<br>(№п/д,
                                дата,
                                сума)<br>[61]
                            </th>
                            <th data-field="dn_sluj_primus" data-sortable="true" rowspan="3" data-halign="center"
                                data-align="center">Дата/№ службової<br>записки щодо необхідності<br>примусового
                                виконання<br>рішення
                                суду<br>[62]
                            </th>
                            <th data-field="dn_lz_vikon_list" data-sortable="true" rowspan="3" data-halign="center"
                                data-align="center">Подано до суду лист-заяву<br>про видачу виконавчого<br>листа
                                (дата/№)
                            </th>
                            ...
                            <th data-field="napr_zai_police" data-sortable="true" rowspan="3" data-halign="center"
                                data-align="center">Направлено запит до <br>органів національної поліції<br>про ухилення
                                від
                                виконання<br>рішення суду
                                <br>[72]
                            </th>
                            <th data-field="napr_info_bank" data-sortable="true" rowspan="3" data-halign="center"
                                data-align="center">Направлено інформацію до<br>банківських установ про<br>наявність
                                несплачених<br>штрафних
                                санкцій<br>[73]
                            </th>
                            ...
                            <th data-field="napr_info_prokuror" data-sortable="true" rowspan="3" data-halign="center"
                                data-align="center">Направлено інформацію до<br>органів прокуратури про<br>наявність
                                несплаченої<br>штрафної
                                санкції<br>[75]
                            </th>
                        ...
                        <tr>
                            ...
                            <th data-field="name_apel_sud" data-sortable="true" rowspan="2" data-halign="center"
                                data-align="center">Назва апеляційного<br>адміністративного суду,<br>дата/№ апецяційної
                                скарги
                            </th>
                            <th colspan="2" data-halign="center" data-align="center">Прийняття апеляційної<br>скарги до
                                розгляду
                            </th>
                            ...
                            <th colspan="2" data-halign="center" data-align="center">Прийняття касаційної<br>скарги до
                                розгляду
                            </th>
                            ...
                            <th data-field="splach_sud_zbir" data-sortable="true" rowspan="2" data-halign="center"
                                data-align="center">Сплачено та/або застосовано<br> звільнення,
                                розстрочення(відстрочення)<br>
                            ...
                            <th data-field="povern_sud_zbir" data-sortable="true" rowspan="2" data-halign="center"
                                data-align="center">Повернуто судовий збір <br>за рішенням суду до бюджету<br>(№п/д,
                                дата, сума)<br>[59]
                            </th>
                            ...
                            <th data-field="dn_rekv_otk_vp" data-sortable="true" rowspan="2" data-halign="center"
                                data-align="center">Реквізити Постанови про<br>розпочате ВП<br>(дата/вх.№
                                Нацкомфінпослуг)
                            </th>
                            ...
                            <th data-field="dn_rekv_zak_vp" data-sortable="true" rowspan="2" data-halign="center"
                                data-align="center">Реквізити Постанови про<br>закриття ВП/повернення<br>виконавчого
                                листа<br>(дата/вх.№
                                Нацкомфінпослуг)
                            </th>
                        ...
                        <tr>
                            <th data-field="n_sud_sprav" data-sortable="true" data-halign="center" data-align="center">№
                                судової
                                справи/<br>вхі.№<br>Нацкомфінпослуг
                            </th>
                            <th data-field="d_sud_rish" data-sortable="true" data-halign="center" data-align="center">
                                Дата
                                судового рішення/<br>дата за вх.№<br>Нацкомфінпослуг
                            </th>
                            <th data-field="d_sud_rish_ros" data-sortable="true" data-halign="center"
                            ...
                            <th data-field="n_ssprav_apel" data-sortable="true" data-halign="center"
                                data-align="center">№
                                судової справи/<br>вхі.№<br>Нацкомфінпослуг
                            </th>
                            <th data-field="d_srish_apel" data-sortable="true" data-halign="center" data-align="center">
                                Дата
                                судового рішення/<br>дата за вх.№<br>Нацкомфінпослуг
                            </th>
                            <th data-field="d_res_srish_apel" data-sortable="true" data-halign="center"
                                data-align="center">Дата
                                судового рішення/<br>дата за вх.№<br>Нацкомфінпослуг
                            </th>
                            <th data-field="short_zm_rish_apel" data-sortable="true" data-halign="center"
                                data-align="center"
                                class="col-xs-1">Короткий зміст рішення
                            </th>
                            <th data-field="n_sprav_kasac" data-sortable="true" data-halign="center"
                                data-align="center">№
                                судової справи/<br>вхі.№<br>Нацкомфінпослуг
                            </th>
                            <th data-field="d_rish_kasac" data-sortable="true" data-halign="center" data-align="center">
                                Дата
                                судового рішення/<br>дата за вх.№<br>Нацкомфінпослуг
                            </th>
                            <th data-field="d_rish_res_kasac" data-sortable="true" data-halign="center"
                                data-align="center">Дата
                                судового рішення/<br>дата за вх.№<br>Нацкомфінпослуг
                            </th>
                            <th data-field="short_zm_rish_kasac" data-sortable="true" data-halign="center"
                                data-align="center"
                                class="col-xs-1">Короткий зміст рішення
                            </th>
                        ...
                        <tbody id="table_body">
                        <?php $new_table = get_table_inspect($_REQUEST["page"]);
                        $table_inspekt = $new_table[0];
                        $table_type_fu = get_dic('dic_type_fu');
